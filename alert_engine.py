        ...
        with conn.cursor() as cur:
            ...
            for rule in rules:
                ...
                if condition_met and not is_triggered:
                    ...
                    cur.execute("UPDATE rules SET is_currently_triggered = TRUE WHERE id = %s", (rule_id,))
                    ...
                    cur.execute("UPDATE rules SET is_currently_triggered = FALSE WHERE id = %s", (rule_id,))
