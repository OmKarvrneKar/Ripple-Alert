...
- **Real-Time Market Sentiment**: Utilizes a standalone microservice to scrape top-tier crypto news feeds (e.g., Cointelegraph), evaluate headlines using rapid keyword sentiment analysis (Bullish/Bearish), and export aggregated mood scores via API for frontend integration.
